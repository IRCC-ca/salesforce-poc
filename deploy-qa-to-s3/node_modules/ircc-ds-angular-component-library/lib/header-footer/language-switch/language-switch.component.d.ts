...
export declare const LANGUAGE_SWITCH_TEXT_ENGLISH_MOBILE = "<abbr title=\"Fran\u00E7ais\">FR</abbr>";
export declare const LANGUAGE_SWITCH_TEXT_FRENCH = "English";
export declare const LANGUAGE_SWITCH_TEXT_FRENCH_MOBILE = "<abbr title=\"English\">EN</abbr>";
export declare class LanguageSwitchComponent implements OnInit {
    ...
    text: string;
    aria: string;
    constructor(platformId: object, langToggle: LanguageHeaderFooterSwitchService, translate: TranslateService, router: Router, titleService: TitleStrategy);
