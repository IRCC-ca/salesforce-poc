...
export declare class navItemAccordionComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<navItemAccordionComponent, "ircc-cl-lib-nav-accordion", never, { "config": "config"; "id": "id"; "open": "open"; "label": "label"; "size": "size"; "iconLeading": "iconLeading"; "leftPadding": "leftPadding"; "bold": "bold"; }, {}, never, ["*"], false>;
}
