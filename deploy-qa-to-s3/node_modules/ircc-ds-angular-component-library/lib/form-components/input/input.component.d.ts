import { AfterContentChecked, ChangeDetectorRef, ElementRef, EventEmitter, OnChanges, OnInit, Renderer2 } from '@angular/core';
...
export declare const ARIA_TEXT: {
    en: {
        ...
        btnTypeAutoCompleteClear: string;
    };
    fr: {
        btnTypePasswordAriaLabel: string;
        btnTypePasswordShowAriaLabel: string;
...
export declare class InputComponent implements ControlValueAccessor, OnInit, OnChanges, AfterContentChecked {
    ...
    btnAriaTypeAutoCompleteClear: string;
    errorIds: IErrorIDs[];
    errorAria: string;
    ...
    buttonAutoCompleteClearClicked: boolean;
    constructor(standAloneFunctions: StandAloneFunctions, translate: TranslateService, changeDetectorRef: ChangeDetectorRef, renderer: Renderer2);
    onTouch: () => void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<InputComponent, "ircc-cl-lib-input", never, { "config": "config"; "id": "id"; "formGroup": "formGroup"; "type": "type"; "size": "size"; "label": "label"; "hint": "hint"; "desc": "desc"; "required": "required"; "placeholder": "placeholder"; "errorMessages": "errorMessages"; }, { "focusEvent": "focusEvent"; }, never, never, false>;
}
